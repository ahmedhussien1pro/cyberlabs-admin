...
export const ENDPOINTS = {
  ...
  USERS: {
    ...
    ACTIVITY: (id: string) => `${BASE}/users/${id}/activity`,
  },
  COURSES: {
    LIST:         `${BASE}/courses`,
  ...
  REFERRALS: {
    LIST:   `${BASE}/referrals`,
    CREATE: `${BASE}/referrals`,
    DETAIL: (id: string) => `${BASE}/referrals/${id}`,
    DELETE: (id: string) => `${BASE}/referrals/${id}`,
    STATS:  `${BASE}/referrals/stats`,
  },
} as const;
...
export const API_ENDPOINTS = {
  ...
  USERS: {
    ...
    ACTIVITY: ENDPOINTS.USERS.ACTIVITY,
  },
  REFERRALS: ENDPOINTS.REFERRALS,
};
