...
import { AlertCircle, ArrowLeft, Edit, Trash2, Shield, Clock, Trophy } from 'lucide-react';
...
export default function LabDetailPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              {lab.ar_title && (
                <div className="text-sm text-muted-foreground">{lab.ar_title}</div>
              )}
            </div>
            <div>
            ...
            <div className="flex gap-2">
              ...
              {lab.executionMode && <Badge variant="secondary">{lab.executionMode}</Badge>}
            </div>
            <div>
      ...
      {lab.flagAnswer && (
        <FlagAnswerField flagAnswer={lab.flagAnswer} />
      )}
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{lab.title}"? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
