...
export function CurriculumPanel() {
  const { topics, selectedTopicId, updateElement, updateTopic } =
    useCourseEditorStore();

  const [selectedTopicIdLocal, setSelectedTopicIdLocal] = useState<
    string | null
  >(null);
  ...
  const activeElement =
    activeTopic?.elements.find((el) => el.id === selectedElementId) ?? null;
