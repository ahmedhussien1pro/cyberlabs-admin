...
const STATE_OPTIONS: {
  ...
  {
    value: 'PUBLISHED',
    labelKey: 'state.PUBLISHED',
    icon: Globe,
    color: 'text-emerald-400',
  },
  {
    value: 'COMING_SOON',
    labelKey: 'state.COMING_SOON',
    icon: Clock,
    color: 'text-blue-400',
  },
  {
    value: 'DRAFT',
    labelKey: 'state.DRAFT',
    icon: EyeOff,
    color: 'text-zinc-400',
  },
];
    ...
    <>
      ...
      <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t('dialogs.deleteTitle', { title: course.title })}
            </AlertDialogTitle>
            <AlertDialogDescription>
