...
export function GrowthChart({ data }: GrowthChartProps) {
  ...
  const totalEnrollments = data.enrollments.reduce((sum, item) => sum + item.count, 0);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Monthly user registrations and course enrollments</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-lg border p-4">
              ...
              <div className="text-sm text-muted-foreground">New Users (12 months)</div>
            </div>
            <div className="rounded-lg border p-4">
              <div className="text-2xl font-bold">{totalEnrollments}</div>
              <div className="text-sm text-muted-foreground">Enrollments (12 months)</div>
            </div>
          </div>
